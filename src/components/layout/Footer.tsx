  ...
  return (
    <footer className="bg-[#0b1326] w-full py-12 px-8">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto border-t border-white/5 pt-12">
        <div className="text-md sm:text-lg font-black text-[#b4c5ff]"><span className="text-[#7bd0ff]">BuildWith</span>Shihab</div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 leading-relaxed text-center md:text-right">
          {t('footer.copyright')}
        </p>
      </div>
    </footer>
